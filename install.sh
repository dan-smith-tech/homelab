...
# install packages
pacman -S --noconfirm base efibootmgr git grub linux linux-firmware linux-headers lvm2 networkmanager neovim nvidia-container-toolkit nvidia-open nvidia-utils opencl-nvidia openssh sudo
